...
(function(e) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(n) { return e(n, window, document) }) : "object" === typeof exports ? module.exports = function(n, o) { n || (n = window); if (!o || !o.fn.dataTable) o = require("datatables.net")(n, o).$; return e(o, n, n.document) } : e(jQuery, window, document) })(function(e, n, o, m) {
    ...
    l.background = function(a, b, c, d) {
        c === m && (c = 400);
        d || (d = o.body);
        a ? e("<div/>").addClass(b).css("display", "none").insertAfter(d).fadeIn(c) : e("div." + b).fadeOut(c, function() { e(this).removeClass(b).remove() })
    };
    l.instanceSelector = function(a, b) {
        if (!a) return e.map(b, function(a) { return a.inst });
        var c = [],
    ...
    l.buttonSelector = function(a, b) {
        for (var c = [], d = function(a, b, c) {
                ...
                if (e.isArray(a) || a instanceof e) { f = 0; for (h = a.length; f < h; f++) g(a[f], b) } else if (null === a || a === m || "*" === a) { f = 0; for (h = i.length; f < h; f++) c.push({ inst: b, node: i[f].node }) } else if ("number" === typeof a) c.push({ inst: b, node: b.s.buttons[a].node });
    ...
    e.extend(k, {
        collection: {
            ...
            action: function(a, b, c, d) {
                ...
                f && "absolute" === g ? d._collection.css({ top: f.top, left: f.left }) : "absolute" === g ? (d._collection.css({ top: a.top + c.outerHeight(), left: a.left }), f = h.offset().top + h.height(), f = a.top + c.outerHeight() + d._collection.outerHeight() - f, g = a.top - d._collection.outerHeight(), g = h.offset().top - g, (f > g || d.dropup) &&
                ...
                var j = function() {
                    d._collection.fadeOut(d.fade, function() { d._collection.detach() });
                ...
                setTimeout(function() {
                    ...
                    if (d.autoClose) b.on("buttons-action.b-internal", function() { j() })
                }, 10)
            },
            background: !0,
            collectionLayout: "",
        ...
        pageLength: function(a) {
            var a = a.settings()[0].aLengthMenu,
                ...
                c = e.isArray(a[0]) ?
                a[1] : a,
                d = function(a) { return a.i18n("buttons.pageLength", { "-1": "Show all rows", _: "Show %d rows" }, a.page.len()) };
            return {
                extend: "collection",
                text: d,
    ...
    i.Api.register("buttons.info()",
        function(a, b, c) {
            var d = this;
            if (!1 === a) return e("#datatables_buttons_info").fadeOut(function() { e(this).remove() }), clearTimeout(r), r = null, this;
            r && clearTimeout(r);
            ...
            c !== m && 0 !== c && (r = setTimeout(function() { d.buttons.info(!1) }, c));
            return this
        });
    i.Api.register("buttons.exportData()", function(a) {
        if (this.context.length) {
            var b = new i.Api(this.context[0]),
                c = e.extend(!0, {}, { rows: null, columns: "", modifier: { search: "applied", order: "applied" }, orthogonal: "display", stripHtml: !0, stripNewlines: !0, decodeEntities: !0, trim: !0, format: { header: function(a) { return d(a) }, footer: function(a) { return d(a) }, body: function(a) { return d(a) } }, customizeData: null }, a),
                d = function(a) {
                ...
                h =
                e.extend({}, c.modifier);
            b.select && "function" === typeof b.select.info && h.selected === m && b.rows(c.rows, e.extend({ selected: !0 }, h)).any() && e.extend(h, { selected: !0 });
    ...
    f.extend(n.prototype, {
        ...
        _focus: function(a, b, c, d) {
            ...
            if (this.s.enable) {
                if ("number" !== typeof a) {
                    ...
                    var m = a.index(),
                        b = m.column,
                        a = j.rows({ filter: "applied", order: "applied" }).indexes().indexOf(m.row);
                    if (0 > a) return;
        ...
        _shift: function(a, b, c) {
            var d = this.s.dt,
                ...
                i = this._columns();
            if (g) {
                var h = d.rows({ filter: "applied", order: "applied" }).indexes().indexOf(g.index().row);
